...
unlocked to sign the KenFMcoin-Qt.app bundle.
...
allowing somebody to distribute a KenFMcoin-Qt.app or kenfmcoin-qt-setup.exe with a valid
...
that the kenfmcoin-qt.exe file inside the installer had not been tampered with.
