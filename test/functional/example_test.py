...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the KenFMcoinTestFramework
    pass

class ExampleTest(KenFMcoinTestFramework):
    # Each functional test is a subclass of the KenFMcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        KenFMcoinTestFramework class so other tests can use it."""
