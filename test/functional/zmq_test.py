...
from test_framework.test_framework import KenFMcoinTestFramework, SkipTest
from test_framework.util import (assert_equal,
                                 bytes_to_hex_str,
                                 hash256,
                                )

class ZMQTest (KenFMcoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that kenfmcoin has been built with ZMQ enabled
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("kenfmcoind has not been built with zmq enabled.")
        ...
        ip_address = "tcp://127.0.0.1:21965"
