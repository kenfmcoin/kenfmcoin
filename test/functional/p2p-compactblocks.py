...
# TestNode: A peer we use to send messages to kenfmcoind, and store responses.
...
class CompactBlocksTest(KenFMcoinTestFramework):
    ...
    # This test actually causes kenfmcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that kenfmcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for kenfmcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # kenfmcoind will not send blocktxn responses for blocks whose height is
