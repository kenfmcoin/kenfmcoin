// Copyright (c) 2015 The KenFMcoin Core developers
...
BOOST_AUTO_TEST_CASE(get_next_work_pow_limit)
{
    ...
    pindexLast.nBits = 0x1e0ffff0;
    BOOST_CHECK_EQUAL(CalculateNextWorkRequired(&pindexLast, nLastRetargetTime, chainParams->GetConsensus()), 0x1e0ffff0);
}
