...
{
    BOOST_CHECK(TestSplitHost("www.kenfmcoin.org", "www.kenfmcoin.org", -1));
    BOOST_CHECK(TestSplitHost("[www.kenfmcoin.org]", "www.kenfmcoin.org", -1));
    BOOST_CHECK(TestSplitHost("www.kenfmcoin.org:80", "www.kenfmcoin.org", 80));
    BOOST_CHECK(TestSplitHost("[www.kenfmcoin.org]:80", "www.kenfmcoin.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:1966", "127.0.0.1", 1966));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:1966", "127.0.0.1", 1966));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:1966", "::ffff:127.0.0.1", 1966));
    BOOST_CHECK(TestSplitHost("[::]:1966", "::", 1966));
    BOOST_CHECK(TestSplitHost("::1966", "::1966", -1));
    BOOST_CHECK(TestSplitHost(":1966", "", 1966));
    BOOST_CHECK(TestSplitHost("[]:1966", "", 1966));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:1966", "127.0.0.1:1966"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:1966", "[::]:1966"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
