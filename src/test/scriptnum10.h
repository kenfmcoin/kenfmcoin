...
#ifndef KENFMCOIN_TEST_SCRIPTNUM10_H
#define KENFMCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from KenFMcoin Core 0.10.0, for cross-comparison.
 */
public:
