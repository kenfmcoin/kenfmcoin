...
#ifndef KENFMCOIN_WALLET_WALLET_H
#define KENFMCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this kenfmcoin node, and set to 0 for transactions that were created
...
#endif // KENFMCOIN_WALLET_WALLET_H
