...
#if defined(NDEBUG)
# error "KenFMcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "KenFMcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s KEN additional fees, %d delta bytes\n",
...
{
    // KenFMcoin: 100% of all coins are mined in the first block
    if (nHeight == 1)
        return 84000000 * COIN;
    else
        return 0;
...
void ThreadScriptCheck() {
    RenameThread("kenfmcoin-scriptch");
