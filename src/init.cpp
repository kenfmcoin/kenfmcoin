 ...
 * between kenfmcoind, and kenfmcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("kenfmcoin-shutoff");
...
#ifndef WIN32
    strUsage += HelpMessageOpt("-pid=<file>", strprintf(_("Specify pid file (default: %s)"), KENFMCOIN_PID_FILENAME));
#endif
...
{
    const std::string URL_SOURCE_CODE = "<https://gitlab.com/kenfmcoin/kenfmcoin>";
    const std::string URL_WEBSITE = "<https://core.kenfmcoin.org>";
...
void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("kenfmcoin-loadblk");
...
/** Sanity checks
 *  Ensure that KenFMcoin is running in a usable environment with all
...
static bool LockDataDirectory(bool probeOnly)
{
    ...
    // Make sure only a single KenFMcoin process is using the data directory.
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    LogPrintf("Using config file %s\n", GetConfigFile(gArgs.GetArg("-conf", KENFMCOIN_CONF_FILENAME)).string());
