...
This document provides guidelines for internationalization of the KenFMcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `kenfmcoin_en.ts` remains unchanged.
