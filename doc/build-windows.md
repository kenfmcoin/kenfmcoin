...
Below are some notes on how to build KenFMcoin Core for Windows.
...
way. This will install to `c:\workspace\kenfmcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/kenfmcoin
